...
async function webscrap(name, rangefrom, rangeto, pincode){
    ...
    for(let i=0;i<links.length;i++)
    {
        (async function(){
            ...
            let product = {}
            product.srno = mainProduct.length + 1
            ...
            {
                origprice = document.querySelector("span.a-color-secondary.a-text-strike").textContent;
